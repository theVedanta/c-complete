...
const For = () => {
    return (
        <section className="index-for py-20 pt-48">
            <Container>
                <h3 className="font-medium text-5xl text-center text-black mt-32 mb-10 leading-normal">
                ...
                <div className="for-cards flex justify-center items-center w-full">
                    <div className="for-card">
                        ...
                        <p>
                            ...
                            <br />
                            <br />
                            Internal and External, Coaches & Mentors use Multi
                            Rater feedback for providing impactful results.
                        </p>
                    </div>
                    <div className="for-card">
                        <h3 className="font-semibold text-blue text-3xl mb-6">
