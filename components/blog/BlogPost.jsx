...
const BlogPost = () => {
    return (
        <div className="blog-post z-30 relative mt-6 px-12 py-10 rounded-2xl bg-white text-black flex flex-col items-center">
            <h1 className="text-center text-5xl leading-snug font-semibold w-1/2">
            ...
            <p className="mt-10 w-full text-lg">
                ...
                <br />
                <br />
                The Colleges must evaluate and train Students on these basic
                behaviors to prepare them for their first years as
                Professionals.
            </p>
        </div>
    );
